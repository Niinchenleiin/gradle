...
public abstract class NativeComponentPlugin implements Plugin<Project> {
    ...
    public void apply(final Project project) {
        ...
        BuildTypeContainer buildTypes = project.getExtensions().create(BuildTypeContainer.class, "buildTypes", DefaultBuildTypeContainer.class);
        FlavorContainer flavors = project.getExtensions().create(FlavorContainer.class, "flavors", DefaultFlavorContainer.class);
